# VerteX, Zot, and Zarf Runbook

Use this reference when a task involves the Palette VerteX management
appliance, its internal Zot registry, publishing Zarf packages, or testing the
Add Zarf profile experience. Never commit registry passwords, private keys,
kubeconfigs, or Zarf signing keys.
